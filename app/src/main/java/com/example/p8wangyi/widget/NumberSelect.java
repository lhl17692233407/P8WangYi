package com.example.p8wangyi.widget;
...
public class NumberSelect extends LinearLayout implements View.OnClickListener {
    ...
    public void addPage(int layout){
        ...
        addView(view);
        txtReduce = view.findViewById(R.id.txt_reduce1);
        txtNumber = view.findViewById(R.id.txt_number1);
        txtAdd = view.findViewById(R.id.txt_add1);
